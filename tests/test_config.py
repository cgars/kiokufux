...
def test_write_and_load_default_config(tmp_path):
    ...
    assert "person" in cfg.autotagging.candidate_tags
    assert "handwriting" in cfg.autotagging.candidate_tags
    assert "elderly_person" in cfg.autotagging.candidate_tags
